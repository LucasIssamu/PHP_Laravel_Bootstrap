...
<!-- Formulario -->
<form action="/Resultado4" method="post">
    @csrf
        ...
        <div class="container">
            <div class="d-md-flex align-items-center justify-content-between">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <p class="lead">
                            Desenvolva um programa que receba um valor digitado pelo usuário e verifique se esse
                            valor é positivo, negativo ou igual a zero. Imprima na tela: "Valor Positivo",
                            "Valor Negativo", "Igual a Zero".
                        </p>
                    </div>
                </div>
            </div>
